...
module.exports = "file://" + context.plugin.urlForResourceNamed("_webpack_resources/f2cde1725c43911646644534056239b6.html").path();
...
function get_file(owner, repo, path, callback, error_callback) {
  ...
  fetch("https://api.github.com/repos/".concat(owner, "/").concat(repo, "/contents/").concat(path), {
    ...
    return error_callback("There was a problem with ".concat(owner, "/").concat(repo, "/").concat(path));
  });
}
...
/*!***************************!*\
  !*** ./src/miss_modal.js ***!
  \***************************/
/*! exports provided: handle_misses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handle_misses", function() { return handle_misses; });
...
function handle_misses(document, misses) {
  ...
  webContents.on('did-finish-load', function () {
    ...
    for (var i in misses[0]) {
      name = misses[1][i];
      webContents.executeJavaScript("addElement('".concat(name, "', ").concat(i, ");")).catch(console.error);
    }
  }); // add a handler for a call from web content's javascript

  webContents.on('selected', function (index) {
...
/* harmony import */ var _miss_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./miss_modal */ "./src/miss_modal.js");
...
var traverse = function traverse(layers, lexicon) {
  ...
  for (var index in layers) {
    ...
    if (layer instanceof sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Text && layer.name.startsWith('$')) {
      ...
      console.log("## checking string existance for ".concat(name, " "));

      if (lexicon.hasOwnProperty(name)) {
        console.log("value: ".concat(lexicon[name], " "));
        layer.sketchObject.setStringValue(convertHtmlToRtf(lexicon[name]));
      } else {
        console.log("#### ".concat(name, "'s value is missing"));
        missing.push(layer);
      ...
      for (var index in layer.overrides) {
        ...
        if (override.property == 'stringValue' && override.affectedLayer.name.startsWith('$')) {
          ...
          if (lexicon.hasOwnProperty(name)) {
            console.log("it's value is ".concat(lexicon[name], " "));
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  Object(_settings__WEBPACK_IMPORTED_MODULE_1__["check_settings_exist"])(context); // if settings are set does nothing, else prompts for settings

  var files = Settings.settingForKey('files') || [];

  if (files.length == 0) {
    Object(_settings__WEBPACK_IMPORTED_MODULE_1__["check_settings_are_right"])(context, "There are no files specified");
  ...
  Promise.all(files.map(function (value, index, array) {
    ...
    return new Promise(function (resolve, reject) {
      Object(_github_requests__WEBPACK_IMPORTED_MODULE_2__["get_file"])(value[0], value[1], value[2], function (dictionary) {
        console.log("#### ".concat(value, " content ####"));
    ...
    if (layers.length > 0) {
      ...
      var misses = traverse(layers, library[modal_res[1]]);
      Object(_miss_modal__WEBPACK_IMPORTED_MODULE_3__["handle_misses"])(doc, misses);
    } else {
